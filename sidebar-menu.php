...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
  ...
  if ($_GET["module"]=="obat" || $_GET["module"]=="form_obat") { ?>
    <li class="active">
      <a href="?module=obat"><i class="fa fa-folder"></i> Data Barang </a>
      </li>
  <?php
  }
  ...
  if ($_GET["module"]=="obat_masuk" || $_GET["module"]=="form_obat_masuk") { ?>
    <li class="active">
      <a href="?module=obat_masuk"><i class="fa fa-clone"></i> Data Barang Masuk </a>
      </li>
  <?php
  }
  ...
  if ($_GET["module"]=="obat_keluar" || $_GET["module"]=="form_obat_keluar") { ?>
    <li class="active">
      <a href="?module=obat_keluar"><i class="fa fa-clone"></i> Data Barang Keluar </a>
      </li>
  <?php 
  }
  // jika tidak, menu data obat masuk tidak aktif
	...
	if ($_GET["module"]=="lap_stok") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		...
        		<li><a href="?module=lap_obat_masuk"><i class="fa fa-circle-o"></i> Barang Masuk </a></li>
            <li class="active"><a href="?module=lap_obat_keluar"><i class="fa fa-circle-o"></i> Barang Keluar </a></li>
      		</ul>
    	</li>
    <?php
	}
	...
	elseif ($_GET["module"]=="lap_obat_masuk") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		...
        		<li class="active"><a href="?module=lap_obat_masuk"><i class="fa fa-circle-o"></i> Barang Masuk </a></li>
            <li class="active"><a href="?module=lap_obat_keluar"><i class="fa fa-circle-o"></i> Barang Keluar </a></li>
      		</ul>
    	</li>
    <?php
...
elseif ($_SESSION['hak_akses']=='Produksi') { ?>
	<!-- sidebar menu start -->
    <ul class="sidebar-menu">
        <li class="header">MAIN MENU</li>
...
if ($_SESSION['hak_akses']=='Marketing') { ?>
	<!-- sidebar menu start -->
    <ul class="sidebar-menu">
        <li class="header">MAIN MENU</li>
